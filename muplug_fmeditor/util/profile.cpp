...
// 数値パラメータ取得
//----------------------------------------
DWORD Profile::getParam(char *pSessionName,char *pKeyName,DWORD dDefaultValue){
...
// 数値パラメータ設定
//----------------------------------------
BOOL  Profile::setParam(char *pSessionName,char *pKeyName,DWORD param){
	char cValue[256];
...
// 文字パラメータ取得
//----------------------------------------
BOOL Profile::getParam(char *pValue,char *pSessionName,char *pKeyName,char *pDefault){
...
// 文字パラメータ設定
//----------------------------------------
BOOL  Profile::setParam(char *pSessionName,char *pKeyName,char *pValue){
